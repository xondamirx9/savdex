    ...
    public static function менюРолей(): array
    {
        ...
        return [
            'Администратор' => [AdminAccess::ADMIN, [
                'CRM' => $crm,
                'Поддержка' => ['Обращения'],
                'Контент' => ['Главная страница', 'Новости', 'Страницы и FAQ', 'Тендеры'],
                'Модерация' => ['Отзывы', 'Жалобы на контакты', 'Документы на проверку'],
            ...
            'Поддержка' => [AdminAccess::SUPPORT, [
                ...
                'Поддержка' => ['Обращения'],
                'Модерация' => ['Отзывы', 'Жалобы на контакты'],
            ...
            'Контент-менеджер' => [AdminAccess::CONTENT_MANAGER, [
                'Контент' => ['Главная страница', 'Новости', 'Страницы и FAQ'],
                'Справочники' => ['Категории', 'Типы компаний'],
                'Система' => ['Рассылки'],
            ]],
        ];
