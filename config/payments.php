...
return [
    ...
    'providers' => [
        ...
        'uzum' => [
            ...
            /*
             * Исходящий прокси со статическим IP: Uzum открывает доступ
             * к API только с одного конкретного адреса, а у хостинга
             * адреса общие и плавающие. Формат — как у cURL:
             * http://логин:пароль@хост:порт. Через прокси идут только
             * запросы к Uzum (CONNECT-туннель, TLS до Uzum сквозной,
             * ключи прокси не видны). Пусто — прокси не используется
             */
