...
class ImageStore
{
    ...
    /**
     * Баннер во всю ширину: широкий и невысокий.
     *
     * Ограничение по высоте нарочно мягкое — макеты акций бывают
     * и 3:1, и 5:1, и обрезать чужую работу по своему представлению
     * о красоте неправильно.
     */
    public const BANNER = ['w' => 2400, 'h' => 1200, 'quality' => 82];

    /** Тот же баннер для телефона: узкий экран, меньше трафика. */
    public const BANNER_MOBILE = ['w' => 1000, 'h' => 1400, 'quality' => 80];
