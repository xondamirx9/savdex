                ...
                ->schema([
                    ...
                    FileUpload::make('value_image')
                        ...
                        ->helperText(fn (Get $get): string => $get('key') === Appearance::KEY_LOGO
                            ? 'SVG или PNG с прозрачным фоном, квадратный, от 512 px. Знак стоит и на белом, и на тёмно-синем фоне шапки, поэтому сплошная белая подложка на нём будет заметна. Пустое поле возвращает знак по умолчанию'
