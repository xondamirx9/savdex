...
<head>
    ...
    {{--
        Lato со стороннего домена. Локальный был бы быстрее — внешний
        запрос откладывает отрисовку текста и ставит скорость площадки
        в зависимость от чужого сервера, а из Узбекистана европейские
        CDN отвечают заметно медленнее. Пока шрифт внешний, второй
        preconnect с crossorigin обязателен: без него браузер открывает
        соединение только под стили, а под сами woff2 — заново, и это
        лишний круг до первой отрисовки текста.

        Начертания 400, 700 и 900 — все, что есть у Lato из нужных нам.
        Промежуточных 500 и 600 у семейства не существует, и просить их
        нельзя: ответ на несуществующее начертание ломает весь запрос,
        и страница осталась бы вообще без шрифта. Браузер подбирает их
        сам по правилам CSS — см. комментарий у --font-sans.
    --}}
    <link rel="preconnect" href="https://fonts.bunny.net">
    <link rel="preconnect" href="https://fonts.bunny.net" crossorigin>
    <link href="https://fonts.bunny.net/css?family=lato:400,700,900&display=swap" rel="stylesheet">
