...
<head>
    ...
    {{--
        Arimo со стороннего домена. Локальный был бы быстрее — внешний
        ...
        Начертания 400, 500, 600 и 700 — весь диапазон Arimo: тяжелее
        700 у семейства ничего нет. Просить несуществующее нельзя —
        ответ на такой запрос ломает весь список, и страница осталась
        бы вообще без шрифта.
    --}}
    <link rel="preconnect" href="https://fonts.bunny.net">
    <link rel="preconnect" href="https://fonts.bunny.net" crossorigin>
    <link href="https://fonts.bunny.net/css?family=arimo:400,500,600,700&display=swap" rel="stylesheet">
