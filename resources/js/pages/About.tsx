...
const FAQ: [string, string][] = [
    ...
    [
        'Как оплатить из Узбекистана и из-за рубежа?',
        'Из Узбекистана — картой Uzcard или Humo через Payme, Click, Uzum, в сумах. Из других стран — Visa, Mastercard, American Express в долларах.',
    ],
];
